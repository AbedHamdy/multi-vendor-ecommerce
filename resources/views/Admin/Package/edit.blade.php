...
<div class="container py-4">
    {{-- <pre>{{ dd($package->features) }}</pre> --}}
    <div class="card shadow border-0">
        <div class="card-body">
            <h4 class="fw-bold mb-4 text-center">Edit Package</h4>
                ...
                <div id="features-wrapper">
                    @foreach ($package->features as $feature)
                        <div class="input-group mb-2 feature-item">
                            <input type="text" name="features[]" class="form-control" value="{{ old('features.'.$loop->index, $feature->title) }}" required>
