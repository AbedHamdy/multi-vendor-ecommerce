            ...
            <div class="col-lg-7">
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4">
                        ...
                        <p class="text-center text-muted mb-4">Please provide your shipping details and select a payment
                            method</p>
                        ...
                        <form action="{{ route('client.checkout.process') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="shipping_address" name="shipping_address"
                                    placeholder="Enter your shipping address" value="{{ old('shipping_address') }}"
                                    required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="payment_method" name="payment_method" required>
                                    <option value="" disabled {{ old('payment_method') ? '' : 'selected' }}>Select a
                                        payment method</option>
                                    <option value="stripe" {{ old('payment_method') == 'stripe' ? 'selected' : '' }}>Credit
                                        / Debit Card (Stripe)</option>
                                    <option value="cash" {{ old('payment_method') == 'cash' ? 'selected' : '' }}>Cash on
                                        Delivery</option>
                                </select>
                            </div>
